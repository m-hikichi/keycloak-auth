...
# フロントチャネル（ブラウザが踏むURL）→ PUBLIC を使う
AUTH_URL = f"{KC_BASE_PUBLIC}/realms/{REALM}/protocol/openid-connect/auth"
# バックチャネル（コンテナから叩くURL）→ INTERNAL を使う
TOKEN_URL = f"{KC_BASE_INTERNAL}/realms/{REALM}/protocol/openid-connect/token"
